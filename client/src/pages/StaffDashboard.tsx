...
import { Scan, LogOut, AlertCircle, CheckCircle2, Clock, TrendingUp, Boxes, AlertTriangle, User } from "lucide-react"
...
export default function StaffDashboard() {
  ...
  // Fetch today's staff dashboard data
  const { data: dashboardData } = useQuery<StaffDashboardData>({
  ...
  // Use dashboard data from the proper endpoint
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">{inventoryTotal - maintenanceItems}</p>
                  </div>
                  <div>
